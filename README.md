...
_ Проект состоит из нескольких репозиториев. Данный репозиторий отвечает за веб-приложение (сервер и api). [Репозиторий c нативное приложение](https://github.com/hitfot/CardReaderNative) _
